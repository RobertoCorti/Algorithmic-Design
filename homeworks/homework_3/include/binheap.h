...
typedef struct {
  ...
  total_order_type leq;     //criterion of heap order--> heap total order
  void* max_order_value;    //max value of the order stored by the heap
 ...
 *                 the size of A).
 * @param key_size is the typesize of the values stored in A.
