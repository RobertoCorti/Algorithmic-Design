...
{ 
  if (n <= (1<<6)) {
    ...
    // P5 = S5 x S6
    strassen_opt_aux(P[0], (const float* const *const) S[0],
    ...
    // P2 = S2 x B22
    strassen_opt_aux(P[2], (const float* const *const) S[1], B,          
                     0, 0,
                     0, 0,
                     B_f_row + n2, B_f_col + n2,
                     n2);
    ...
    // P6 = S7 x S8
    strassen_opt_aux(P[3], (const float* const *const) S[0], (const float* const *const) S[1],          
                     0, 0,
                     0, 0,
                     0, 0,
                     n2);
    ...
    sub_matrix_blocks(S[0], B, B,
                      ...
                      n2);
    // P1 = A11 x S1
    strassen_opt_aux(P[3], A, (const float* const *const) S[0],
                     0, 0,
                     A_f_row, A_f_col,
                     0, 0,
                     n2);
    ...
    sum_matrix_blocks(S[0], A, A,
                      ...
                      n2);
    // P3 = S3 x B11
    strassen_opt_aux(P[2], (const float* const *const) S[0], B,
                     0, 0,
                     0, 0,
                     B_f_row, B_f_col,
                     n2);
    ...
    // C21 = P3 + P4
    sum_matrix_blocks(C, (const float* const *const)P[2], (const float* const *const)P[1],
                      C_f_row+n2, C_f_col,
                      0, 0,
                      0, 0,
                      n2);
    ...
    // P7 = S9 x S10
    strassen_opt_aux(P[1], (const float* const *const)S[0], (const float* const *const)S[1],
                     0, 0,
                     0, 0,
                     0, 0,
                     n2);
